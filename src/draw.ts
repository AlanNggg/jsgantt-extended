...
export const GanttChart = function (pDiv, pFormat) {
    ...
    this.drawCharBody = function (
        ...
        for (i = 0; i < this.vTaskList.length; i++) {
            ...
            if (this.vTaskList[i].getMile() && !vComb) {
                ...
                let vTmpDiv2 = newNode(
                    ...
                    this.vTaskList[i].getClass() + " gtaskbar",
                    null,
                    12
                );
                ...
                if (this.vTaskList[i].getGroup()) {
                    ...
                    if (vComb) {
                        vTmpDivCell = vTmpDiv = this.vTaskList[i]
                            .getParItem()
                            .getCellDiv();
                    } else {
                    ...
                    if (
                        ...
                        const vTmpPlanDiv2 = newNode(
                            ...
                            "div",
                            this.vDivId + "taskbar_" + vID,
                            this.vTaskList[i].getClass() + " gtaskbar gplan",
                            null,
                            vTaskPlanRightPx
                        );
        ...
        if (vSingleCell) {
            ...
            const vTmpTFootTCellTableTBody = newNode(
                vTmpTFootTCellTable,
                "tbody"
            );
    ...
    this.drawColsChart = function (
        ...
        if (
            ...
            columnCurrentDay =
                Math.floor(
                    calculateCurrentDateOffset(curTaskStart, curTaskEnd) /
                        onePeriod
                ) - 1;
        }
    ...
    this.Draw = function () {
         ...
         * LIST BODY
         */
        const { vNumRows, vTmpContentTabWrapper } =
        ...
        if (this.vDraggable) {
            addDragAndDropListeners(this, rightvTmpDiv);
        }
